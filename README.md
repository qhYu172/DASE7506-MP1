...
**Frozen full-test result:** **1.6091548 bits per byte (BPB)**, with **19.471 seconds** of FP32 CPU scoring time. The matching [checkpoint](code/runs/iter_13/checkpoint.pt) is included in this repository, so evaluation does not require retraining. See the [academic report](REPORT.md) and [experiment log](EXPERIMENT.md) for methods and controls.
